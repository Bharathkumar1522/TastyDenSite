...
const Contact = () => {
    const whatsappNumber = "918142762285";
    const callNumber = "+918074473895";
            ...
            <div className="cta-content">
                ...
                >
                    <h2 className="cta-title">
                        Ready to <span style={{ color: 'var(--gold)' }}>Order?</span>
                    </h2>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <button onClick={handleChatClick} className="btn-whatsapp">
